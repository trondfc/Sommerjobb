...
En dimmensjonalt jage spill på en neopixel led stripe.

Hver spiller har en knapp for og flytte sin plasering en fremover. Tar spilleren igjenn motspilleren får den et påeng, og spillet resetes til start posisjonen. Spillet vinnes av første spiller til og nå `SCORE_TO_WIN` (her satt til 5) påeng.

![image](Schematic.png)
[ChaseGame.ino](ChaseGame.ino)
```cpp

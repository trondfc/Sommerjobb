...
Timing spill på en neopixel stripe.

Spillets mål er og trykke på knappen idet spiller posisjonen er den samme som mål posisjonen. Spiller posisjonen går rundt og rundt, og øker faren hver gang måle treffes. Bommer spilleren på målet fremvises påengsummen, og spillet restarter.

Det er lagt till en "Easy mode" ettersom normal modus er svert krevende.

![image](Schematic.png)
[TimingGame.ino](TimingGame.ino)
```cpp

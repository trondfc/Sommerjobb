...
void loop() {
  start(IR_DIRECTION, IR_BRIGHTNES, defaultPeriod);
  delay(DELAY_TIME);
  stop();
  delay(DELAY_TIME);
...
void start(bool direction, uint16_t brightness, uint16_t period)
{

...
For sending av IR datapakker fra zumo bilen må det genereres en subcarier frekvens på IR lysdiodene med 38kHz. For og gjøre dette er funksjonene fra `Zumo32U4IRPulses` biblioteket benyttet. Disse funksjonene brukes så til og skru av og på LED PWM signalene med timing som tilsvarer NEC standaren.

[SendIRCommand.ino](SendIRCommand.ino)
